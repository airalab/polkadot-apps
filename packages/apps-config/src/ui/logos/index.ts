...
export const namedLogos: Record<string, unknown> = {
  ...
  airalabEarth: nodeRobonomics,
  airalabMars: nodeRobonomics,
  airalab2077: nodeRobonomics,
  airalabUranus: nodeRobonomics,
  airalabMercury: nodeRobonomics,
  rococo: chainRococo,
