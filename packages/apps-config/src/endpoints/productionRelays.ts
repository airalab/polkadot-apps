...
import { createAiralab } from './productionRelayAiralab';
...
export function createAiralabRelay (t: TFunction, firstOnly?: boolean): LinkOption[] {
  return expandEndpoints(t, [createAiralab(t)], firstOnly);
}
